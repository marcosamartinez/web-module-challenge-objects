...
let object = createMenuItem("coffee", 5 , "drink");
console.log(createMenuItem(object));
...
*/
const object1 = createMenuItem("tea", 9, "drink");
const object2 = createMenuItem("frap", 7, "drink");
const object3 = createMenuItem("coffee", 6, "drink");
console.log(createMenuItem(object1))
console.log(createMenuItem(object3))
console.log(createMenuItem(object2))
